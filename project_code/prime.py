...
from tensorflow.keras.layers import LSTM, Dense, Dropout, Conv1D, MaxPooling1D, Input, concatenate, Attention
...
if os.path.exists(model_path):
    ...
    conv_layer = Conv1D(filters=64, kernel_size=3, activation='relu')(conv_input)  # Match the number of filters to LSTM units
